const topicData = {
  observables: {
    ...
    noteLink: 'quantum/foundations-observables.pdf',
  ...
  symmetry: {
    ...
    noteLink: 'quantum/rotations-wigner-eckart.pdf',
  ...
  adiabatic: {
    ...
    noteLink: 'quantum/adiabatic-sudden-approx.pdf',
  ...
  ptsymmetry: {
    ...
    noteLink: 'quantum/scattering-pt-symmetry.pdf',
...
function renderTopic(topicKey) {
  ...
  detailImage.textContent = data.visual;
}
...
viewQuantum.addEventListener('click', openQuantumSection);
backQuantum.addEventListener('click', closeQuantumSection);
